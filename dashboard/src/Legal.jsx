            ...
            <main className="max-w-3xl mx-auto px-6 py-12">
                ...
                <Section title="What we keep, and for how long">
                    <ul className="list-disc pl-6 space-y-1">
                        ...
                        <li>
                            <strong className="text-white">API keys (DeepSeek, ElevenLabs, Upload-Post):</strong> stored
                ...
                <Section title="Third-party APIs">
                    <p>
                        ...
                        API for which you provided a key — Google DeepSeek (AI analysis), ElevenLabs (optional dubbing),
